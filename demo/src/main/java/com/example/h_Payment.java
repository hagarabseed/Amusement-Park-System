...
public class h_Payment {
    private int paymentId;
    private h_Booking booking;
    private h_PaymentProcessor paymentProcessor;
    private boolean status = false;

    public h_Payment(int paymentId, h_Booking booking, h_PaymentProcessor paymentProcessor) {
